...
class EmailSender:
    def __init__(self, smtp_id='', smtp_pw='', smtp_server='smtp.kakaowork.com', smtp_port=465):
        ...
        self.smtp_id = smtpId if smtp_id == '' else smtp_id
        self.smtp_pw = smtpPw if smtp_pw == '' else smtp_pw
        self.smtp_server = smtp_server
        self.smtp_port = smtp_port

    def send_email(self, mail_subject, mail_body, mail_to, mail_cc='', mail_bcc='', mail_attachments=None):
        """
        이메일 전송 메서드
